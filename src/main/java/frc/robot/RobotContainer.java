...
new JoystickButton(driverXbox, 4).onTrue(Autos.driveToAprilTag(drivebase, 4, Rotation2d.fromDegrees(0),
Rotation2d.fromDegrees(0), new Translation2d(Units.inchesToMeters(-36),0)));
new JoystickButton(driverXbox, 5).onTrue(Autos.driveToAprilTag(drivebase, 8, Rotation2d.fromDegrees(0),
